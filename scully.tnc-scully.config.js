...
// setPluginConfig(getGaPlugin(), <GoogleAnalyticsConfig>{
//   dryRun: true,
...
exports.config = {
    ...
    outDir: './dist/static',
    defaultPostRenderers: [scully_plugin_minify_html_1.MinifyHtml, scully_plugin_http404_1.getHttp404Plugin(), 'seoHrefOptimise'],
    routes: {
        '/blog/:slug': {
