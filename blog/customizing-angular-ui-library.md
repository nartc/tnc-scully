...
description: Utilizing Directive to customize third-party UI library with Angular
date: '2020-10-20'
published: true
...
Now, you might be jumping to conclusion that "We're going to use `HostListener` to listen to the `click` event then
